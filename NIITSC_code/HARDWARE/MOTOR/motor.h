...
#define BIN1_GPIO_PIN       GPIO_Pin_1
#define BIN2_GPIO_PIN   		GPIO_Pin_0
#define BIN_GPIO_PORT  			GPIOD
#define BIN_GPIO_CLK 				RCC_AHB1Periph_GPIOD


#define CIN1_GPIO_PIN       GPIO_Pin_12
#define CIN2_GPIO_PIN   		GPIO_Pin_11
...
#define MOTORA_PWM_PIN           						   GPIO_Pin_5       		 // MOTOR1_PWM 引脚      
...
#define MOTORA_PWM_OC_INIT(initStructure)			 TIM_OC2Init(MOTORA_PWM_TIM, (TIM_OCInitTypeDef*)(initStructure))
#define MOTORA_PWM_OC_PRELOAD_CFIG() 					 TIM_OC2PreloadConfig(MOTORA_PWM_TIM, TIM_OCPreload_Enable)

/*---------------------- MOTORB_PWM------------------------*/

#define MOTORB_PWM_PIN       						       GPIO_Pin_8       		 // MOTOR2_PWM 引脚      
#define MOTORB_PWM_PORT      						       GPIOB                  // MOTOR2_PWM GPIO端口    
#define MOTORB_PWM_SOURCE    						       GPIO_PinSource8                  // MOTOR2_PWM GPIO端口  
#define MOTORB_PWM_PIN_CLK   						       RCC_AHB1Periph_GPIOB	 // MOTOR2_PWM GPIO端口时钟
																				 
#define MOTORB_PWM_TIM       						       TIM4                  // MOTOR2_PWM GPIO端口  
#define MOTORB_PWM_AF        						       GPIO_AF_TIM4
#define MOTORB_PWM_TIM_CLK   						       RCC_APB1Periph_TIM4	 // MOTOR2_PWM GPIO端口时钟
#define MOTORB_PWM_OC_INIT(initStructure)			 TIM_OC3Init(MOTORB_PWM_TIM, (TIM_OCInitTypeDef*)(initStructure))
#define MOTORB_PWM_OC_PRELOAD_CFIG() 					 TIM_OC3PreloadConfig(MOTORB_PWM_TIM, TIM_OCPreload_Enable)
